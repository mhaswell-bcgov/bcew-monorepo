...
- Operational and monorepo workflows are intentionally centralized and excluded from this README. See `tools/monorepo-plugin/README.md` for setup, development, and build instructions.
